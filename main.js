...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,uBAAuB;IACvB,sGAAsG;IACtG,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,WAAW;AACf;;AAEA;IACI,kBAAkB;IAClB,SAAS;IACT,WAAW;IACX,iBAAiB;IACjB,iCAAiC;IACjC,iBAAiB;AACrB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,iBAAiB;IACjB,gBAAgB;IAChB,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,iCAAiC;AACrC;;AAEA;IACI,aAAa;IACb,mBAAmB;;AAEvB;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,oBAAoB;IACpB,sBAAsB;IACtB,mCAAmC;AACvC;;AAEA;IACI,gBAAgB;IAChB,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,oBAAoB;IACpB,sBAAsB;AAC1B;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,gBAAgB;IAChB,8BAA8B;IAC9B,iBAAiB;IACjB,eAAe;AACnB;;;AAGA,uBAAuB;;AAEvB;IACI,oCAAoC;IACpC,gBAAgB;IAChB,gBAAgB;IAChB,aAAa;IACb,6BAA6B;IAC7B,mBAAmB;IACnB,yBAAyB;AAC7B;;AAEA;IACI,aAAa;IACb,gCAAgC;IAChC,SAAS;IACT,WAAW;IACX,iBAAiB;IACjB,iBAAiB;AACrB;;AAEA;IACI,cAAc;IACd,sBAAsB;IACtB,+BAA+B;IAC/B,mBAAmB;IACnB,+BAA+B;AACnC;;AAEA;IACI,iBAAiB;IACjB,gBAAgB;IAChB,yBAAyB;IACzB,+BAA+B;IAC/B,eAAe;IACf,iCAAiC;AACrC;;;AAGA;IACI,cAAc;IACd,aAAa;IACb,2BAA2B;IAC3B,iCAAiC;AACrC;;AAEA;IACI,WAAW;IACX,aAAa;IACb,sBAAsB;IACtB,oCAAoC;IACpC,6BAA6B;IAC7B,4BAA4B;AAChC;;AAEA;IACI,WAAW;IACX,aAAa;IACb,sBAAsB;IACtB,2BAA2B;IAC3B,oCAAoC;IACpC,gCAAgC;IAChC,+BAA+B;AACnC;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB;;;AAGA;IACI,YAAY;IACZ,WAAW;IACX,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,gBAAgB;IAChB,gBAAgB;IAChB,8BAA8B;IAC9B,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,WAAW;AACf;;;;AAIA,gBAAgB;;AAEhB;IACI,WAAW;IACX,gBAAgB;IAChB,iCAAiC;AACrC;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,kBAAkB;IAClB,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,eAAe;IACf,aAAa;IACb,gBAAgB;IAChB,iBAAiB;;AAErB;;AAEA;IACI,gBAAgB;IAChB,gBAAgB;IAChB,0CAA0C;IAC1C,YAAY;IACZ,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,4BAA4B;IAC5B,mBAAmB;AACvB;;AAEA;IACI,oBAAoB;IACpB,sBAAsB;IACtB,0CAA0C;AAC9C;;AAEA;IACI,mBAAmB;IACnB,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,8BAA8B;AAClC;;AAEA;IACI,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,6BAA6B;IAC7B,kBAAkB;IAClB,2CAA2C;AAC/C;;AAEA;IACI,sBAAsB;IACtB,kBAAkB;AACtB","sourcesContent":["html {\n    height: 100%;\n}\n\nbody {\n    position: relative;\n    min-height: 100%;\n    background: rgb(2,0,36);\n    background: radial-gradient(circle, rgba(2,0,36,1) 0%, rgba(22,70,74,1) 20%, rgba(100,159,136,1) 100%);\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center; \n    margin: 0px;\n}\n\n.signature {\n    position: absolute;\n    top: 10px;\n    right: 20px;\n    color: whitesmoke;\n    font-family: \"Nunito\", sans-serif;\n    font-weight: bold;\n}\n\na {\n    text-decoration: none;\n}\n\n.taskbar-container {\n    min-width: 1465px;\n    max-height: 60px;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    font-family: \"Nunito\", sans-serif;\n}\n\n#search-form {\n    display: flex;\n    align-items: center;\n    \n}\n\n#search-bar {\n    height: 18px;\n    padding: 5px;\n    width: 220px;\n    border: none;\n    border-radius: 20px;\n    margin-right: 8px;\n}\n\n#search-bar:hover {\n    transition: all 0.3s;\n    transform: scale(1.05);\n    box-shadow: 2px 2px 18px -3px black;\n}\n\n.search-button {\n    background: none;\n    border: none;\n    width: 30px;\n}\n\n.search-icon:hover {\n    transition: all 0.3s;\n    transform: scale(1.08);\n}\n\n.search-icon {\n    height: 18px;\n}\n\n.date-holder {\n    display: flex;\n    min-width: 500px;\n    justify-content: space-between;\n    color: whitesmoke;\n    font-size: 20px;\n}\n\n\n/* dashboard section: */\n\n.weather-card-container {\n    background-color: rgb(136, 164, 178);\n    max-height: 85vh;\n    max-width: 180vh;\n    display: grid;\n    grid-template-rows: 2fr 1.2fr;\n    border-radius: 10px;\n    border: 6px solid #a7bcb9;\n}\n\n.top-half {\n    display: grid;\n    grid-template-columns: 3.5fr 1fr;\n    gap: 18px;\n    margin: 5px;\n    padding: 0px 15px;\n    padding-top: 15px;\n}\n\n.current-weather-card {\n    grid-column: 1;\n    background-size: cover;\n    transition: background-image 5s;\n    border-radius: 25px;\n    box-shadow: -3px -1px 10px -4px;\n}\n\n.current-information {\n    margin-left: 90px;\n    margin-top: 50px;\n    color: rgb(251, 249, 249);\n    text-shadow: 0px 0px 28px black;\n    font-size: 27px;\n    font-family: \"Nunito\", sans-serif;\n}\n\n\n.days-forecast-container {\n    grid-column: 2;\n    display: grid;\n    grid-template-rows: 1fr 1fr;\n    font-family: \"Nunito\", sans-serif;\n}\n\n.tomorrow-container {\n    grid-row: 1;\n    display: flex;\n    flex-direction: column;\n    background-color: rgb(245, 245, 245);\n    border-top-right-radius: 20px;\n    border-top-left-radius: 20px;\n}\n\n.tomorrow2-container {\n    grid-row: 2;\n    display: flex;\n    flex-direction: column;\n    border-top: 2px solid black;\n    background-color: rgb(245, 245, 245);\n    border-bottom-right-radius: 20px;\n    border-bottom-left-radius: 20px;\n}\n\n.tomorrow-container > h3 {\n    align-self: center;\n    font-size: 23px;\n}\n\n.tomorrow2-container > h3 {\n    align-self: center;\n    font-size: 23px;\n}\n\n\n.day-forecast-icon {\n    height: 95px;\n    width: 95px;\n    align-self: center;\n}\n\n.high-low-box {\n    position: relative;\n    display: flex;\n    max-height: 50px;\n    margin: 0px 60px;\n    justify-content: space-between;\n    align-items: center;\n    font-size: 22px;\n}\n\n.temp-arrow {\n    width: 50px;\n}\n\n\n\n/* bottom half */\n\n.bottom-half {\n    width: 100%;\n    overflow: hidden;\n    font-family: \"Nunito\", sans-serif;\n}\n\n.forecast-hour-header {\n    margin-top: 10px;\n    margin-left: 27px;\n    margin-bottom: 5px;\n    color: whitesmoke;\n    font-size: 24px;\n}\n\n.forecast-container {\n    display: flex;\n    min-width: 100%;\n    height: 170px;\n    overflow-x: auto;\n    margin:  0px 15px;\n\n}\n\n.forecast-hour-box {\n    min-height: 80px;\n    min-width: 100px;\n    background-color: rgba(127, 188, 249, 0.6);\n    margin: 10px;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    border: 4px solid whitesmoke;\n    border-radius: 10px;\n}\n\n.forecast-hour-box:hover {\n    transition: all 0.3s;\n    transform: scale(1.08);\n    background-color: rgba(167, 205, 243, 0.6);\n}\n\n.forecast-hour-box > h3 {\n    margin-bottom: 10px;\n    margin-top: 10px;\n    font-size: 18px;\n}\n\n.forecast-hour-time {\n    border-bottom: 2px solid black;\n}\n\n.forecast-icon {\n    height: 50px;\n    width: 50px;\n}\n\n.forecast-container::-webkit-scrollbar {\n    width: 13px;\n}\n\n.forecast-container::-webkit-scrollbar-track {\n    background: rgb(97, 152, 210);\n    border-radius: 8px;\n    box-shadow: inset 0 0 6px rgba(0, 0, 0, .3);\n}\n\n.forecast-container::-webkit-scrollbar-thumb {\n    background: whitesmoke;\n    border-radius: 8px;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _icons_scattered_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons/scattered.png */ "./src/icons/scattered.png");
/* harmony import */ var _icons_snow_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./icons/snow.png */ "./src/icons/snow.png");
/* harmony import */ var _icons_partly_cloudy_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icons/partly-cloudy.png */ "./src/icons/partly-cloudy.png");
/* harmony import */ var _icons_storm_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./icons/storm.png */ "./src/icons/storm.png");
/* harmony import */ var _icons_mist_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./icons/mist.png */ "./src/icons/mist.png");
/* harmony import */ var _icons_drizzle_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./icons/drizzle.png */ "./src/icons/drizzle.png");
/* harmony import */ var _icons_fog_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./icons/fog.png */ "./src/icons/fog.png");
/* harmony import */ var _icons_rain_png__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./icons/rain.png */ "./src/icons/rain.png");
/* harmony import */ var _icons_arrow_right_png__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./icons/arrow-right.png */ "./src/icons/arrow-right.png");
/* harmony import */ var _icons_search_png__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./icons/search.png */ "./src/icons/search.png");
...
const controllerDOM = function () {
    ...
    function getSearchIcon() {
        ...
        searchIcon.src = _icons_search_png__WEBPACK_IMPORTED_MODULE_11__;
    ...
    function getCorrectIcon(weatherConditionString) {
        ...
        if (weatherString === 'sunny' || weatherString.includes('clear')) {
            activeIcon.src = _icons_sun_png__WEBPACK_IMPORTED_MODULE_0__

        } else if (weatherString.includes('partly cloudy')) {
            activeIcon.src = _icons_partly_cloudy_png__WEBPACK_IMPORTED_MODULE_4__;

        } else if (weatherString.includes('light rain')) {
            activeIcon.src = _icons_drizzle_png__WEBPACK_IMPORTED_MODULE_7__

        } else if (weatherString.includes('cloudy') || weatherString.includes('overcast')) {
            activeIcon.src = _icons_clouds_png__WEBPACK_IMPORTED_MODULE_1__
            
        } else if (weatherString.includes('patchy')) {
            activeIcon.src = _icons_scattered_png__WEBPACK_IMPORTED_MODULE_2__

        } else if (weatherString.includes('snow')) {
            activeIcon.src = _icons_snow_png__WEBPACK_IMPORTED_MODULE_3__

        } else if (weatherString.includes('rain') || weatherString.includes('moderate rain')) {
            activeIcon.src = _icons_rain_png__WEBPACK_IMPORTED_MODULE_9__

        } else if (weatherString.includes('thunder') || weatherString.includes('lightning')) {
            activeIcon.src = _icons_storm_png__WEBPACK_IMPORTED_MODULE_5__

        } else if (weatherString.includes('mist')) {
            activeIcon.src = _icons_mist_png__WEBPACK_IMPORTED_MODULE_6__

        } else if (weatherString.includes('drizzle')) {
            activeIcon.src = _icons_drizzle_png__WEBPACK_IMPORTED_MODULE_7__

        }  else if (weatherString.includes('fog')) {
            activeIcon.src = _icons_fog_png__WEBPACK_IMPORTED_MODULE_8__
    ...
    function createTempBox(tempHigh, tempLow, fatherContainer) {
        ...
        tempArrow.src = _icons_arrow_right_png__WEBPACK_IMPORTED_MODULE_10__;
...
module.exports = __webpack_require__.p + "12e10324db7b3ad8ef8f.png";
...
const initialDOM = (0,_userInterface__WEBPACK_IMPORTED_MODULE_2__.controllerDOM)();
initialDOM.getSearchIcon();
